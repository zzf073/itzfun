...
//static CGFloat const kJPSThumbnailAnnotationViewStandardWidth     = 175.0f;
...
static CGFloat const kJPSThumbnailAnnotationViewStandardHeight    = 70.0f;
...
- (void)setupImageView {
    ...
    _mainTitleLabel = [[UILabel alloc] initWithFrame:CGRectMake(12.5f, 10.0f, 75.0f, 35.0f)];
    _mainTitleLabel.textColor = [UIColor darkTextColor];
    _mainTitleLabel.font = [UIFont boldSystemFontOfSize:12];
    _mainTitleLabel.minimumScaleFactor = 0.8f;
...
- (void)setupTitleLabel {
    ...
    _titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(-80.0f, 18.5f, 250.0f, 20.0f)];
...
- (void)setupDisclosureButton {
    ...
    //_disclosureButton.frame = CGRectMake(kJPSThumbnailAnnotationViewExpandOffset/2.0f + self.frame.size.width/2.0f + 8.0f,26.5f,disclosureIndicatorImage.size.width,disclosureIndicatorImage.size.height);
    _disclosureButton.frame = CGRectMake(kJPSThumbnailAnnotationViewExpandOffset/2.0f + self.frame.size.width/2.0f + 25.0f,18.5f,disclosureIndicatorImage.size.width,disclosureIndicatorImage.size.height);
...
- (void)updateWithThumbnail:(JPSThumbnail *)thumbnail {
    ...
    self.mainTitleLabel.text = thumbnail.mainTitle;
